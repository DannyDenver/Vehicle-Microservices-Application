...
public class CarService {
    ...
    public CarService(@Value("${pricing.endpoint}") String endpoint, CarRepository repository, PriceClient webClientPricing, MapsClient webClientMaps) {
        /**
    ...
    public Car findById(Long id) {
         ...
         */
        Optional<Car> foundCar = this.repository.findById(id);
        ...
        if (car.getId() != null) {
            return repository.findById(car.getId())
                    .map(carToBeUpdated -> {
                        ...
                        System.out.println(carToBeUpdated);
